...
namespace Oracle.NoSQL.Driver
{
    ...
    /// <see cref="M:Oracle.NoSQL.Driver.NoSQLClient.ListTablesAsync*"/> API
    /// and partial results when iterating with
    /// <see cref="M:Oracle.NoSQL.Driver.NoSQLClient.GetListTablesAsyncEnumerable*"/>.
    /// </para>
    /// <para>
    ...
    public class ListTablesResult
    {
        ...
        /// <see cref="M:Oracle.NoSQL.Driver.NoSQLClient.ListTablesAsync*"/>
