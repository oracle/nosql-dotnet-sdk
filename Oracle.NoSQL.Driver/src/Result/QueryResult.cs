...
namespace Oracle.NoSQL.Driver
{
    ...
    /// <see cref="M:Oracle.NoSQL.Driver.NoSQLClient.QueryAsync*"/> API and
    /// partial results when iterating with
    /// <see cref="M:Oracle.NoSQL.Driver.NoSQLClient.GetQueryAsyncEnumerable*"/>.
    ...
    /// </para>
    /// <para>
    /// When using <see cref="M:Oracle.NoSQL.Driver.NoSQLClient.QueryAsync*"/>
    /// API, if the value of
    ...
    /// <see cref="M:Oracle.NoSQL.Driver.NoSQLClient.QueryAsync*"/> to
    /// continue the query.  In general,
    /// <see cref="M:Oracle.NoSQL.Driver.NoSQLClient.QueryAsync*"/> should be
    ...
    /// <para>
    /// It is possible that
    /// <see cref="M:Oracle.NoSQL.Driver.NoSQLClient.QueryAsync*"/>
    ...
    /// <see cref="M:Oracle.NoSQL.Driver.NoSQLClient.QueryAsync*"/> or
    /// iterating via <c>await foreach</c> to get results, if any exist.
    /// </para>
    /// <para>
    /// It is also a normal situation if that the last call to
    /// <see cref="M:Oracle.NoSQL.Driver.NoSQLClient.QueryAsync*"/> (when the
    ...
    public class QueryResult<TRow> : IDataResult
    {
        ...
        /// <see cref="M:Oracle.NoSQL.Driver.NoSQLClient.QueryAsync*"/>.  It is
        /// not needed if
        /// using
        /// <see cref="M:Oracle.NoSQL.Driver.NoSQLClient.GetQueryAsyncEnumerable*"/>.
        /// </remarks>
        ...
        /// <see cref="M:Oracle.NoSQL.Driver.NoSQLClient.QueryAsync*"/> can
    ...
    /// <see cref="M:Oracle.NoSQL.Driver.NoSQLClient.QueryAsync*"/> as
    ...
    /// <see cref="M:Oracle.NoSQL.Driver.NoSQLClient.QueryAsync*"/>.  For each
