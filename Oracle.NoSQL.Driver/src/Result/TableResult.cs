...
namespace Oracle.NoSQL.Driver
{
    ...
    /// <see cref="M:Oracle.NoSQL.Driver.NoSQLClient.GetTableAsync*"/>,
    ...
    /// <see cref="Driver.TableState.Active"/> or
    /// <see cref="Driver.TableState.Dropped"/>.
    /// </para>
    /// <para>
    ...
    public class TableResult
    {
        ...
        /// state should be <see cref="Driver.TableState.Active"/> or
        /// <see cref="Driver.TableState.Dropped"/> (only for
