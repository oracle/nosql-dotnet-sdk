...
namespace Oracle.NoSQL.Driver
{
    ...
    public class DeleteRangeOptions : IOptions
    {
        ...
        /// <see cref="M:Oracle.NoSQL.Driver.NoSQLClient.DeleteRangeAsync*"/> or
        /// via iterating over
        /// <see cref="M:Oracle.NoSQL.Driver.NoSQLClient.GetDeleteRangeAsyncEnumerable*"/>.
        /// </remarks>
        /// <value>
        ...
        /// <remarks>
        /// <para>
        /// Only for use with <see cref="M:Oracle.NoSQL.Driver.NoSQLClient.DeleteRangeAsync*"/>.
        ...
        /// call to <see cref="M:Oracle.NoSQL.Driver.NoSQLClient.DeleteRangeAsync*"/>
