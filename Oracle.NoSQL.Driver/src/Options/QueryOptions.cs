...
namespace Oracle.NoSQL.Driver
{
    ...
    /// <see cref="M:Oracle.NoSQL.Driver.NoSQLClient.QueryAsync*"/> and
    ...
    /// <see cref="M:Oracle.NoSQL.Driver.NoSQLClient.QueryAsync*"/> or to each
    ...
    public class QueryOptions : IReadOptions
    {
        ...
        /// <see cref="M:Oracle.NoSQL.Driver.NoSQLClient.QueryAsync*"/> or to
        ...
        /// multiple calls to
        /// <see cref="M:Oracle.NoSQL.Driver.NoSQLClient.QueryAsync*"/> or full
        /// iteration over
        /// <see cref="M:Oracle.NoSQL.Driver.NoSQLClient.GetQueryAsyncEnumerable*"/>).
        /// </para>
        /// </remarks>
