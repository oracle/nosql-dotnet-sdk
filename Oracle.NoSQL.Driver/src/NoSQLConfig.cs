...
namespace Oracle.NoSQL.Driver
{
    ...
    public partial class NoSQLConfig
    {
        ...
        /// <see cref="Driver.ServiceType.Unspecified"/>, in which case the
        ...
        /// <see cref="Driver.Region.RegionId"/>).
        /// </para>
        /// <para>
        ...
        /// endpoint.  E.g. <see cref="Driver.Region.US_PHOENIX_1"/> has
        ...
        /// <see cref="Driver.Consistency.Eventual"/>.
        /// </value>
        /// <seealso cref="Driver.Consistency"/>
        ...
        /// <item>
        /// <description>
        /// For <see cref="Driver.ServiceType.Cloud"/>, the driver will use an
        ...
        /// <item>
        /// <description>
        /// For <see cref="Driver.ServiceType.CloudSim"/> no authorization is
        /// required.
        /// </description>
        /// </item>
        /// <item>
        /// <description>
        /// For <see cref="Driver.ServiceType.KVStore"/>, the driver will
        ...
        /// </value>
        /// <seealso cref="Driver.ConnectionOptions"/>
